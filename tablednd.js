...
document.addEventListener("mousemove", onmousemoveF, false); 

// Similarly for the mouseup
var onmouseupF   = function(ev){
    if (currenttable && currenttable.dragObject) {
...
document.addEventListener("mouseup", onmouseupF, false); 
